...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_PAINT:
    {
        ...
        // Pensler for lys
        HBRUSH hBlack = CreateSolidBrush(RGB(40, 40, 40));
        ...
        HBRUSH hGrey = CreateSolidBrush(RGB(150, 150, 150));

        int leftTLX = cx - roadHalf - tlWidth - 60;   // til venstre for veien
        int leftTLY = cy - tlHeight / 2;              // midtstilt vertikalt
        ...
        int topTLX = cx - 40;                         // litt til venstre for midten
        int topTLY = cy - roadHalf - 100;             // over veien
